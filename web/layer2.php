...
<html>
    ...
    for ($x = 0; $x <= 23; $x++){
        $dir = dirname(__FILE__) . "/layer2/cluster" . $x+1;
        ...
        <div class="main_container">
            ...
            <div class="side_menu">
                ...
                <div class="mapbox_container">
                    <div class="mapbox_info_header">
                        ...
                        <a id="mapbox_info"> Layer 2 Feature Maps (Showing 24/128) </a>
                    </div>
                    <div class="filler"></div>
                    <div class="map_box" id="mapbox">
                        <img src="layer2/featured_imgs/1.png" id="cluster1" onclick="renderCluster(2, 1)">
                        <img src="layer2/featured_imgs/2.png" id="cluster2" onclick="renderCluster(2, 2)"> 
                        <img src="layer2/featured_imgs/3.png" id="cluster3" onclick="renderCluster(2, 3)"> 
                        <img src="layer2/featured_imgs/4.png" id="cluster4" onclick="renderCluster(2, 4)"> 
                        <img src="layer2/featured_imgs/5.png" id="cluster5" onclick="renderCluster(2, 5)"> 
                        <img src="layer2/featured_imgs/6.png" id="cluster6" onclick="renderCluster(2, 6)"> 
                        <img src="layer2/featured_imgs/7.png" id="cluster7" onclick="renderCluster(2, 7)"> 
                        <img src="layer2/featured_imgs/8.png" id="cluster8" onclick="renderCluster(2, 8)"> 
                        <img src="layer2/featured_imgs/9.png" id="cluster9" onclick="renderCluster(2, 9)"> 
                        <img src="layer2/featured_imgs/10.png" id="cluster10" onclick="renderCluster(2, 10)"> 
                        <img src="layer2/featured_imgs/11.png" id="cluster11" onclick="renderCluster(2, 11)"> 
                        <img src="layer2/featured_imgs/12.png" id="cluster12" onclick="renderCluster(2, 12)"> 
                        <img src="layer2/featured_imgs/13.png" id="cluster13" onclick="renderCluster(2, 13)"> 
                        <img src="layer2/featured_imgs/14.png" id="cluster14" onclick="renderCluster(2, 14)"> 
                        <img src="layer2/featured_imgs/15.png" id="cluster15" onclick="renderCluster(2, 15)"> 
                        <img src="layer2/featured_imgs/16.png" id="cluster16" onclick="renderCluster(2, 16)"> 
                        <img src="layer2/featured_imgs/17.png" id="cluster17" onclick="renderCluster(2, 17)"> 
                        <img src="layer2/featured_imgs/18.png" id="cluster18" onclick="renderCluster(2, 18)"> 
                        <img src="layer2/featured_imgs/19.png" id="cluster19" onclick="renderCluster(2, 19)"> 
                        <img src="layer2/featured_imgs/20.png" id="cluster20" onclick="renderCluster(2, 20)"> 
                        <img src="layer2/featured_imgs/21.png" id="cluster21" onclick="renderCluster(2, 21)"> 
                        <img src="layer2/featured_imgs/22.png" id="cluster22" onclick="renderCluster(2, 22)"> 
                        <img src="layer2/featured_imgs/23.png" id="cluster23" onclick="renderCluster(2, 23)"> 
                        <img src="layer2/featured_imgs/24.png" id="cluster24" onclick="renderCluster(2, 24)">     
                    </div>
            ...
            <div class="bottom_container">
                    ...
                    <div class="diagram_holder">
                        ...
                        <img src="images/conv2-2.png" onclick="window.location='layer2.php';" id="selectedlayer">
                        <img src="images/poolinglayer.png">
                        <img src="images/arrow.png" class="arrow"/>
        ...
        <script>
            ...
            function renderCluster(layer, cluster){
                ...
                for(let i=0; i < passedArray.length; i++){
                    ...
                    document.getElementById("mapbox_info").innerHTML = "Layer 2 Feature Maps (Cluster " + cluster + ")";
